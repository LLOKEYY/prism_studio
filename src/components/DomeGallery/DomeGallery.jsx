...
function buildItems(pool, seg) {
  ...
  const normalizedImages = pool.map(image => {
    if (typeof image === 'string') {
      return { src: image, alt: '', projectName: '', projectCategory: '' };
    }
    return {
      src: image.src || '',
      alt: image.alt || '',
  ...
  return coords.map((c, i) => ({
    ...
    projectName: usedImages[i].projectName,
    projectCategory: usedImages[i].projectCategory
  }));
}
            ...
            {items.map((it, i) => (
              ...
              >
                ...
                >
                  ...
                  {it.projectName && (
                    <div className="item__tile-overlay">
                      <span className="item__tile-overlay-name">{it.projectName}</span>
                      <span className="item__tile-overlay-cat">{it.projectCategory}</span>
                    </div>
                  )}
                </div>
              </div>
